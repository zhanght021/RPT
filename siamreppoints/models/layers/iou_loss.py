...
class IOULoss(nn.Module):
    ...
    def forward(self, pred, target, weight=None):
        ...
        distance_center = (pred_center_x - target_center_x) * (pred_center_x - target_center_x) + (pred_center_y - target_center_y) * (pred_center_y - target_center_y)
        distance_intersect = g_w_intersect * g_w_intersect + g_h_intersect * g_h_intersect
        dious = ious - (distance_center / distance_intersect)
