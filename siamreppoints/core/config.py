...
__C.DATASET.VIDEOS_PER_EPOCH = 450000
# ------------------------------------------------------------------------ #
# Backbone options
# ------------------------------------------------------------------------ #
__C.BACKBONE = CN()
...
__C.TRACK.KERNEL_SIZE = (7,7)

__C.TRACK.EXPANSION = 1.00

__C.TRACK.WINDOW_INFLUENCE_FAST = 0.03
__C.TRACK.WINDOW_INFLUENCE_MEDIUM = 0.15
__C.TRACK.SPEED_INFLUENCE = 1.5
